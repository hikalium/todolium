...
if (fs.existsSync(path.join(process.cwd(), 'todo.json'))) {
    console.error('ERROR: Found todo.json in legacy format.\n' +
...
app.post('/api/events', async (req, res) => {
    ...
    const knownEids = new Set(existing.map(e => e.eid));
    const newEvents = incoming.filter(e => !knownEids.has(e.eid));
